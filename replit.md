...
- Hero section mobile optimization: H1 increased to text-5xl on mobile, H2 shortened to single sentence on mobile (full text on tablet+), increased spacing between all elements for better breathing room and visual appeal. Top padding increased to py-24 on mobile for more room above content, H1 has mt-4 top margin on mobile, all vertical gaps increased (gap-12 between sections, mb-8 for H1)
